...
import { require_react } from "./react-DeJ_WYXJ.js";
...
var require_react_is_development = /* @__PURE__ */ __commonJS({ "node_modules/react-is/cjs/react-is.development.js": ((exports) => {
	(function() {
		...
		function isValidElementType(type$1) {
			return typeof type$1 === "string" || typeof type$1 === "function" || type$1 === REACT_FRAGMENT_TYPE || type$1 === REACT_CONCURRENT_MODE_TYPE || type$1 === REACT_PROFILER_TYPE || type$1 === REACT_STRICT_MODE_TYPE || type$1 === REACT_SUSPENSE_TYPE || type$1 === REACT_SUSPENSE_LIST_TYPE || typeof type$1 === "object" && type$1 !== null && (type$1.$$typeof === REACT_LAZY_TYPE || type$1.$$typeof === REACT_MEMO_TYPE || type$1.$$typeof === REACT_PROVIDER_TYPE || type$1.$$typeof === REACT_CONTEXT_TYPE || type$1.$$typeof === REACT_FORWARD_REF_TYPE || type$1.$$typeof === REACT_FUNDAMENTAL_TYPE || type$1.$$typeof === REACT_RESPONDER_TYPE || type$1.$$typeof === REACT_SCOPE_TYPE || type$1.$$typeof === REACT_BLOCK_TYPE);
		}
				...
				switch ($$typeof) {
					case REACT_ELEMENT_TYPE:
						...
						switch (type$1) {
							...
							case REACT_SUSPENSE_TYPE: return type$1;
							default:
...
var require_factoryWithTypeCheckers = /* @__PURE__ */ __commonJS({ "node_modules/prop-types/factoryWithTypeCheckers.js": ((exports, module) => {
	...
	module.exports = function(isValidElement, throwOnDirectAccess$1) {
		...
		*/
		...
		function invalidValidatorError(componentName, location, propFullName, key, type$1) {
			return new PropTypeError((componentName || "React class") + ": " + location + " type `" + propFullName + "." + key + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + type$1 + "`.");
		}
		...
		function getPostfixForTypeWarning(value) {
			var type$1 = getPreciseType(value);
			switch (type$1) {
				case "array":
				case "object": return "an " + type$1;
				case "boolean":
				case "date":
				case "regexp": return "a " + type$1;
